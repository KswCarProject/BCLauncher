...
public class InternetHeaders {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:14:0x0038 A[Catch:{ IOException -> 0x0051 }] */
    /* JADX WARNING: Removed duplicated region for block: B:8:0x0021 A[Catch:{ IOException -> 0x0051 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void load(java.io.InputStream r8) throws javax.mail.MessagingException {
        /*
            r7 = this;
            com.sun.mail.util.LineInputStream r3 = new com.sun.mail.util.LineInputStream
            r3.<init>(r8)
            r4 = 0
            java.lang.StringBuffer r2 = new java.lang.StringBuffer
            r2.<init>()
        L_0x000b:
            java.lang.String r1 = r3.readLine()     // Catch:{ IOException -> 0x0051 }
            if (r1 == 0) goto L_0x0038
            java.lang.String r5 = " "
            boolean r5 = r1.startsWith(r5)     // Catch:{ IOException -> 0x0051 }
        ...
        L_0x0027:
            java.lang.String r5 = "\r\n"
            r2.append(r5)     // Catch:{ IOException -> 0x0051 }
            r2.append(r1)     // Catch:{ IOException -> 0x0051 }
        L_0x002f:
            if (r1 == 0) goto L_0x0037
            int r5 = r1.length()     // Catch:{ IOException -> 0x0051 }
            if (r5 > 0) goto L_0x000b
        L_0x0037:
            return
        L_0x0038:
            if (r4 == 0) goto L_0x003f
            r7.addHeaderLine(r4)     // Catch:{ IOException -> 0x0051 }
        L_0x003d:
            r4 = r1
            goto L_0x002f
        L_0x003f:
            int r5 = r2.length()     // Catch:{ IOException -> 0x0051 }
            if (r5 <= 0) goto L_0x003d
            java.lang.String r5 = r2.toString()     // Catch:{ IOException -> 0x0051 }
            r7.addHeaderLine(r5)     // Catch:{ IOException -> 0x0051 }
            r5 = 0
            r2.setLength(r5)     // Catch:{ IOException -> 0x0051 }
            goto L_0x003d
        L_0x0051:
            r0 = move-exception
            javax.mail.MessagingException r5 = new javax.mail.MessagingException
            java.lang.String r6 = "Error in input stream"
            r5.<init>(r6, r0)
            throw r5
        */
