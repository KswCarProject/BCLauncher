...
public class MimeUtility {
    ...
    private static String encodeWord(String string, String charset, String encoding, boolean encodingWord) throws UnsupportedEncodingException {
        ...
        doEncode(string, b64, jcharset, 68 - charset.length(), "=?" + charset + LocationInfo.NA + encoding + LocationInfo.NA, true, encodingWord, outb);
    ...
    public static String unfold(String s) {
        ...
        while (true) {
            ...
            if (start != 0 && s.charAt(start - 1) == '\\') {
                ...
                s = s.substring(i2);
            } else if (i2 >= l || !((c = s.charAt(i2)) == ' ' || c == 9)) {
                if (sb == null) {
                    sb = new StringBuffer(s.length());
                }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:3:0x0007, code lost:
        r0 = (java.lang.String) mime2java.get(r3.toLowerCase(java.util.Locale.ENGLISH));
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.lang.String javaCharset(java.lang.String r3) {
        /*
            java.util.Hashtable r1 = mime2java
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:3:0x0007, code lost:
        r0 = (java.lang.String) java2mime.get(r3.toLowerCase(java.util.Locale.ENGLISH));
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.lang.String mimeCharset(java.lang.String r3) {
        /*
            java.util.Hashtable r1 = java2mime
            if (r1 == 0) goto L_0x0006
            if (r3 != 0) goto L_0x0007
        L_0x0006:
            return r3
