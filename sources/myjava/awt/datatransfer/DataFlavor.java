...
public class DataFlavor implements Externalizable, Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        if (this.mimeInfo != null) {
            mimeType = (MimeTypeProcessor.MimeType) this.mimeInfo.clone();
        } else {
            mimeType = null;
        }
    ...
    private String getKeyInfo() {
        ...
        return (!this.mimeInfo.getPrimaryType().equals("text") || isUnicodeFlavor()) ? key : String.valueOf(key) + ";charset=" + getCharset().toLowerCase();
    }
    ...
    private static DataFlavor selectBestByCharset(List<DataFlavor> list) {
        List<DataFlavor> best = getFlavors(list, new String[]{"UTF-16", VCardParser_V21.DEFAULT_CHARSET, "UTF-16BE", "UTF-16LE"});
