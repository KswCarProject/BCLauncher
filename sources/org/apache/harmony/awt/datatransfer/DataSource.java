...
public class DataSource implements DataProvider {
    ...
    private RawBitmap getImageBitmap32(BufferedImage bi) {
        ...
        return new RawBitmap(bi.getWidth(), bi.getHeight(), bi.getWidth(), 32, Spanned.SPAN_PRIORITY, MotionEventCompat.ACTION_POINTER_INDEX_MASK, MotionEventCompat.ACTION_MASK, buffer);
    }
