...
public class PropertySetter {
    ...
    public static void setProperties(Object obj2, Properties properties, String prefix) {
        new PropertySetter(obj2).setProperties(properties, prefix);
    }
                ...
                if ((!"layout".equals(key2) && !"errorhandler".equals(key2)) || !(this.obj instanceof Appender)) {
                    ...
                    if (prop != null) {
                        ...
                        if (cls.isAssignableFrom(prop.getPropertyType()) && prop.getWriteMethod() != null) {
                            OptionHandler opt = (OptionHandler) OptionConverter.instantiateByKey(properties, new StringBuffer().append(prefix).append(key2).toString(), prop.getPropertyType(), (Object) null);
                            new PropertySetter(opt).setProperties(properties, new StringBuffer().append(prefix).append(key2).append(".").toString());
                            try {
    ...
    public void setProperty(PropertyDescriptor prop, String name, String value) throws PropertySetterException {
        ...
        try {
            ...
            try {
                ...
                throw new PropertySetterException((Throwable) ex);
            } catch (InvocationTargetException ex2) {
                if ((ex2.getTargetException() instanceof InterruptedException) || (ex2.getTargetException() instanceof InterruptedIOException)) {
                    Thread.currentThread().interrupt();
                }
                throw new PropertySetterException((Throwable) ex2);
            } catch (RuntimeException ex3) {
                throw new PropertySetterException((Throwable) ex3);
            }
        } catch (Throwable t) {
    ...
    public Object convertArg(String val, Class type) {
        ...
        if (!Boolean.TYPE.isAssignableFrom(type)) {
            ...
            if (cls3.isAssignableFrom(type)) {
                ...
                return OptionConverter.instantiateByClassName(v, cls4, (Object) null);
            }
