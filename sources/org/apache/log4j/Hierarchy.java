...
public class Hierarchy implements LoggerRepository, RendererSupport, ThrowableRendererSupport {
    ...
    public Logger getLogger(String name, LoggerFactory factory) {
        ...
        synchronized (this.ht) {
            ...
            if (o == null) {
                ...
                Logger logger3 = factory.makeNewLoggerInstance(name);
                logger3.setHierarchy(this);
                this.ht.put(key, logger3);
                updateChildren((ProvisionNode) o, logger3);
                updateParents(logger3);
                return logger3;
            }
        }
    }
    ...
    public void shutdown() {
        Logger root2 = getRootLogger();
        root2.closeNestedAppenders();
        synchronized (this.ht) {
            Enumeration cats = getCurrentLoggers();
            while (cats.hasMoreElements()) {
            ...
            while (cats2.hasMoreElements()) {
                ((Logger) cats2.nextElement()).removeAllAppenders();
            }
        }
    }
