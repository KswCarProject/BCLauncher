...
public class BoundedFIFO {
    ...
    public BoundedFIFO(int maxSize2) {
        if (maxSize2 < 1) {
            throw new IllegalArgumentException(new StringBuffer().append("The maxSize argument (").append(maxSize2).append(") is not a positive integer.").toString());
        }
        this.maxSize = maxSize2;
        this.buf = new LoggingEvent[maxSize2];
    }
