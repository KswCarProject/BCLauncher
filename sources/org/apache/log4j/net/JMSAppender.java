...
public class JMSAppender extends AppenderSkeleton {
    ...
    public void setTopicConnectionFactoryBindingName(String tcfBindingName2) {
        this.tcfBindingName = tcfBindingName2;
    }
    ...
    public void setTopicBindingName(String topicBindingName2) {
        this.topicBindingName = topicBindingName2;
    }
    ...
    public void activateOptions() {
        ...
        try {
            ...
            this.topicPublisher = this.topicSession.createPublisher((Topic) lookup(jndi, this.topicBindingName));
    ...
    public void setInitialContextFactoryName(String initialContextFactoryName2) {
        this.initialContextFactoryName = initialContextFactoryName2;
    }
    ...
    public void setProviderURL(String providerURL2) {
        this.providerURL = providerURL2;
    }
    ...
    public void setURLPkgPrefixes(String urlPkgPrefixes2) {
        this.urlPkgPrefixes = urlPkgPrefixes2;
    }
    ...
    public void setSecurityCredentials(String securityCredentials2) {
        this.securityCredentials = securityCredentials2;
    }
    ...
    public void setSecurityPrincipalName(String securityPrincipalName2) {
        this.securityPrincipalName = securityPrincipalName2;
    }
    ...
    public void setLocationInfo(boolean locationInfo2) {
