...
public class SMTPAppender extends AppenderSkeleton implements UnrecognizedElementHandler {
    ...
    public SMTPAppender(TriggeringEventEvaluator evaluator2) {
        this.smtpPort = -1;
    ...
    public void activateOptions() {
        ...
        try {
            ...
            if (this.subject != null) {
                try {
                    this.msg.setSubject(MimeUtility.encodeText(this.subject, VCardParser_V21.DEFAULT_CHARSET, (String) null));
    ...
    public void addressMessage(Message msg2) throws MessagingException {
        if (this.from != null) {
            msg2.setFrom(getAddress(this.from));
        } else {
            msg2.setFrom();
        }
        if (this.replyTo != null && this.replyTo.length() > 0) {
            msg2.setReplyTo(parseAddress(this.replyTo));
        }
        if (this.to != null && this.to.length() > 0) {
            msg2.setRecipients(Message.RecipientType.TO, parseAddress(this.to));
        }
        if (this.cc != null && this.cc.length() > 0) {
            msg2.setRecipients(Message.RecipientType.CC, parseAddress(this.cc));
        }
        if (this.bcc != null && this.bcc.length() > 0) {
            msg2.setRecipients(Message.RecipientType.BCC, parseAddress(this.bcc));
        }
    }
    ...
    /* access modifiers changed from: package-private */
    public InternetAddress[] parseAddress(String addressStr) {
        try {
        ...
        try {
            ...
            if (allAscii) {
                ...
                try {
                    ...
                    Writer writer = new OutputStreamWriter(MimeUtility.encode(os, "quoted-printable"), VCardParser_V21.DEFAULT_CHARSET);
                    writer.write(s);
                    writer.close();
    ...
    public void setBufferSize(int bufferSize2) {
        ...
        this.cb.resize(bufferSize2);
    }

    public void setSMTPHost(String smtpHost2) {
        this.smtpHost = smtpHost2;
    }
