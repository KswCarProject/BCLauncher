...
public class Priority {
    ...
    protected Priority(int level2, String levelStr2, int syslogEquivalent2) {
        this.level = level2;
        this.levelStr = levelStr2;
        this.syslogEquivalent = syslogEquivalent2;
    }

    public boolean equals(Object o) {
        if (!(o instanceof Priority) || this.level != ((Priority) o).level) {
            return false;
        }
        return true;
    }
