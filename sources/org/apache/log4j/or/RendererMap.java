...
public class RendererMap {
    ...
    public static void addRenderer(RendererSupport repository, String renderedClassName, String renderingClassName) {
        ...
        ObjectRenderer renderer = (ObjectRenderer) OptionConverter.instantiateByClassName(renderingClassName, cls, (Object) null);
        if (renderer == null) {
    ...
    public ObjectRenderer searchInterfaces(Class c) {
        ...
        for (Class searchInterfaces : ia) {
            ObjectRenderer r2 = searchInterfaces(searchInterfaces);
            if (r2 != null) {
                return r2;
            }
        }
