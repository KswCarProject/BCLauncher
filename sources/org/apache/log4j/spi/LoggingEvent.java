...
public class LoggingEvent implements Serializable {
    ...
    public LoggingEvent(String fqnOfCategoryClass2, Category logger2, Priority level2, Object message2, Throwable throwable) {
        ...
        if (throwable != null) {
            this.throwableInfo = new ThrowableInformation(throwable, logger2);
        }
        this.timeStamp = System.currentTimeMillis();
    }

    public LoggingEvent(String fqnOfCategoryClass2, Category logger2, long timeStamp2, Priority level2, Object message2, Throwable throwable) {
        this.fqnOfCategoryClass = fqnOfCategoryClass2;
        this.logger = logger2;
        this.categoryName = logger2.getName();
        this.level = level2;
    ...
    public LoggingEvent(String fqnOfCategoryClass2, Category logger2, long timeStamp2, Level level2, Object message2, String threadName2, ThrowableInformation throwable, String ndc2, LocationInfo info, Map properties) {
        this.fqnOfCategoryClass = fqnOfCategoryClass2;
        this.logger = logger2;
        if (logger2 != null) {
            this.categoryName = logger2.getName();
    ...
    public java.lang.Object getMDC(java.lang.String r3) {
        ...
        L_0x000d:
            ...
            goto L_0x000c
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.log4j.spi.LoggingEvent.getMDC(java.lang.String):java.lang.Object");
    }
    ...
    private void readLevel(ObjectInputStream ois) throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            this.level = (Level) m.invoke((Object) null, new Integer[]{new Integer(p)});
