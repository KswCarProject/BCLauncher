...
public abstract class NameAbbreviator {
    ...
    private static class PatternAbbreviatorFragment {
        ...
        public PatternAbbreviatorFragment(int charCount2, char ellipsis2) {
            this.charCount = charCount2;
        ...
        public int abbreviate(StringBuffer buf, int startPos) {
            ...
            if (nextDot - startPos > this.charCount) {
                buf.delete(this.charCount + startPos, nextDot);
    ...
    private static class PatternAbbreviator extends NameAbbreviator {
        ...
        public PatternAbbreviator(List fragments2) {
            if (fragments2.size() == 0) {
                throw new IllegalArgumentException("fragments must have at least one element");
            }
            this.fragments = new PatternAbbreviatorFragment[fragments2.size()];
            fragments2.toArray(this.fragments);
        }
