...
public class PropertyConfigurator implements Configurator {
    ...
    public void doConfigure(java.lang.String r8, org.apache.log4j.spi.LoggerRepository r9) {
        /*
            ...
            r4.<init>()
            r2 = 0
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0024 }
        ...
        L_0x0016:
            r7.doConfigure((java.util.Properties) r4, (org.apache.log4j.spi.LoggerRepository) r9)
            r2 = r3
        L_0x001a:
            return
        L_0x001b:
        ...
        L_0x0024:
            r0 = move-exception
        L_0x0025:
            boolean r5 = r0 instanceof java.io.InterruptedIOException     // Catch:{ all -> 0x007b }
            if (r5 != 0) goto L_0x002d
            boolean r5 = r0 instanceof java.lang.InterruptedException     // Catch:{ all -> 0x007b }
            if (r5 == 0) goto L_0x0034
        L_0x002d:
            java.lang.Thread r5 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x007b }
            r5.interrupt()     // Catch:{ all -> 0x007b }
        L_0x0034:
            java.lang.StringBuffer r5 = new java.lang.StringBuffer     // Catch:{ all -> 0x007b }
            r5.<init>()     // Catch:{ all -> 0x007b }
            java.lang.String r6 = "Could not read configuration file ["
            java.lang.StringBuffer r5 = r5.append(r6)     // Catch:{ all -> 0x007b }
            java.lang.StringBuffer r5 = r5.append(r8)     // Catch:{ all -> 0x007b }
            java.lang.String r6 = "]."
            java.lang.StringBuffer r5 = r5.append(r6)     // Catch:{ all -> 0x007b }
            ...
            java.lang.StringBuffer r5 = new java.lang.StringBuffer     // Catch:{ all -> 0x007b }
            r5.<init>()     // Catch:{ all -> 0x007b }
            java.lang.String r6 = "Ignoring configuration file ["
            java.lang.StringBuffer r5 = r5.append(r6)     // Catch:{ all -> 0x007b }
            java.lang.StringBuffer r5 = r5.append(r8)     // Catch:{ all -> 0x007b }
            java.lang.String r6 = "]."
            java.lang.StringBuffer r5 = r5.append(r6)     // Catch:{ all -> 0x007b }
    ...
    public void parseCatsAndRenderers(Properties props, LoggerRepository hierarchy) {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (key.startsWith(CATEGORY_PREFIX) || key.startsWith(LOGGER_PREFIX)) {
                ...
                ThrowableRenderer tr = (ThrowableRenderer) OptionConverter.instantiateByKey(props, THROWABLE_RENDERER_PREFIX, cls, (Object) null);
                if (tr == null) {
    ...
    public Appender parseAppender(Properties props, String appenderName) {
        ...
        Appender appender2 = (Appender) OptionConverter.instantiateByKey(props, prefix, cls, (Object) null);
        if (appender2 == null) {
        ...
        if (appender2 instanceof OptionHandler) {
            if (appender2.requiresLayout()) {
                ...
                Layout layout = (Layout) OptionConverter.instantiateByKey(props, layoutPrefix, cls3, (Object) null);
                if (layout != null) {
            ...
            if (OptionConverter.findAndSubst(errorHandlerPrefix, props) != null) {
                ...
                ErrorHandler eh = (ErrorHandler) OptionConverter.instantiateByKey(props, errorHandlerPrefix, cls2, (Object) null);
                if (eh != null) {
        ...
        while (g.hasMoreElements()) {
            ...
            if (clazz != null) {
                ...
                if (filter != null) {
                    ...
                    Enumeration filterProps = ((Vector) filters.get(key2)).elements();
