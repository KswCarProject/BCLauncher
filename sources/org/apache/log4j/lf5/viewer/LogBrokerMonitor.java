...
public class LogBrokerMonitor {
    ...
    public void show(int delay) {
        if (!this._logMonitorFrame.isVisible()) {
            SwingUtilities.invokeLater(new Runnable(this, delay) {
    ...
    public void addMessage(LogRecord lr) {
        if (!this._isDisposed) {
            SwingUtilities.invokeLater(new Runnable(this, lr) {
                private final LogBrokerMonitor this$0;
    ...
    public void initComponents() {
        ...
        categoryExplorerTreeScrollPane.setPreferredSize(new Dimension(TransportMediator.KEYCODE_MEDIA_RECORD, 400));
    ...
    public void addTableModelProperties() {
        ...
        addDisplayedProperty(new Object(this, model) {
            private final LogBrokerMonitor this$0;
    ...
    public JCheckBoxMenuItem getMenuItem(LogLevel level) {
        ...
        JCheckBoxMenuItem result2 = createMenuItem(level);
        this._logLevelMenuItems.put(level, result2);
        return result2;
    }
    ...
    public JMenuItem createSubMenuItem(LogLevel level) {
        ...
        result.addActionListener(new ActionListener(this, result, level) {
            private final LogBrokerMonitor this$0;
    ...
    public JCheckBoxMenuItem getLogTableColumnMenuItem(LogTableColumn column) {
        ...
        JCheckBoxMenuItem result2 = createLogTableColumnMenuItem(column);
        this._logTableColumnMenuItems.put(column, result2);
        return result2;
    }
    ...
    public void requestOpenMRU(ActionEvent e) {
        ...
        try {
            ...
            new LogFactor5ErrorDialog(getBaseFrame(), new StringBuffer().append("Unable to load file ").append(file).toString());
        }
    }
    ...
    public void closeAfterConfirm() {
        ...
        if (JOptionPane.showConfirmDialog(this._logMonitorFrame, message.toString(), title, 2, 3, (Icon) null) == 0) {
            dispose();
        }
    }
