...
public class ConfigurationManager {
    ...
    public static String treePathToString(TreePath path) {
        ...
        for (int i = 1; i < objects.length; i++) {
            CategoryNode n = (CategoryNode) objects[i];
            if (i > 1) {
                sb.append(".");
            }
    ...
    /* access modifiers changed from: protected */
    public void processRecordFilter(Document doc) {
        String text;
        Node n = doc.getElementsByTagName(NDCTEXTFILTER).item(0);
        if (n != null && (text = getValue(n.getAttributes(), "name")) != null && !text.equals("")) {
            this._monitor.setNDCLogRecordFilter(text);
        }
    }

    /* access modifiers changed from: protected */
    public void processCategories(Document doc) {
        int j;
        boolean z;
    ...
    /* access modifiers changed from: protected */
    public void processLogLevels(Document doc) {
    ...
    /* access modifiers changed from: protected */
    public void processLogLevelColors(Document doc) {
        Node n;
        NodeList nodeList = doc.getElementsByTagName(COLORLEVEL);
        LogLevel.getLogLevelColorMap();
        int i = 0;
        while (i < nodeList.getLength() && (n = nodeList.item(i)) != null) {
    ...
    /* access modifiers changed from: protected */
    public void processLogTableColumns(Document doc) {
        Node n;
    ...
    /* access modifiers changed from: protected */
    public String getValue(NamedNodeMap map, String attr) {
