...
public class LogMonitorAdapter {
    ...
    public static LogMonitorAdapter newInstance(int loglevels) {
        ...
        LogMonitorAdapter adapter2 = newInstance(LogLevel.getLog4JLevels());
        adapter2.setDefaultLevel(LogLevel.DEBUG);
        adapter2.setSevereLevel(LogLevel.FATAL);
        return adapter2;
    }
