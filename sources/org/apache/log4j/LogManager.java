...
public class LogManager {
    ...
    static {
        URL url;
        String override = OptionConverter.getSystemProperty(DEFAULT_INIT_OVERRIDE_KEY, (String) null);
        if (override == null || "false".equalsIgnoreCase(override)) {
            String configurationOptionStr = OptionConverter.getSystemProperty(DEFAULT_CONFIGURATION_KEY, (String) null);
            String configuratorClassName = OptionConverter.getSystemProperty(CONFIGURATOR_CLASS_KEY, (String) null);
