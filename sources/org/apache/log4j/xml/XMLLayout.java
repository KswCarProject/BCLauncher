...
public class XMLLayout extends Layout {
    ...
    public String format(LoggingEvent event) {
        ...
        if (s != null) {
            ...
            for (String appendEscapingCDATA : s) {
        ...
        if (this.locationInfo) {
            LocationInfo locationInfo2 = event.getLocationInformation();
            this.buf.append("<log4j:locationInfo class=\"");
            this.buf.append(Transform.escapeTags(locationInfo2.getClassName()));
            this.buf.append("\" method=\"");
            this.buf.append(Transform.escapeTags(locationInfo2.getMethodName()));
            this.buf.append("\" file=\"");
            this.buf.append(Transform.escapeTags(locationInfo2.getFileName()));
            this.buf.append("\" line=\"");
            this.buf.append(locationInfo2.getLineNumber());
            this.buf.append("\"/>\r\n");
        }
        if (this.properties) {
