...
public class IMAPBodyPart extends MimeBodyPart {
    ...
    public java.io.InputStream getContentStream() throws javax.mail.MessagingException {
        /*
            ...
            com.sun.mail.imap.protocol.BODYSTRUCTURE r11 = r12.bs     // Catch:{ ConnectionException -> 0x005d, ProtocolException -> 0x0071 }
        ...
        if (!this.headersLoaded) {
            ...
            synchronized (this.message.getMessageCacheLock()) {
                try {
                    ...
                    if (p.isREV1()) {
                        BODY b = p.peekBody(this.message.getSequenceNumber(), String.valueOf(this.sectionId) + ".MIME");
                        if (b == null) {
