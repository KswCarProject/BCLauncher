...
public class IMAPStore extends Store implements QuotaAwareStore, ResponseHandler {
    ...
    static class ConnectionPool {
        ...
        /* access modifiers changed from: private */
        public long pruningInterval = FileWatchdog.DEFAULT_DELAY;
        /* access modifiers changed from: private */
    ...
    protected IMAPStore(Session session, URLName url, String name2, int defaultPort2, boolean isSSL2) {
        ...
        if (s3 == null || !s3.equalsIgnoreCase("false")) {
            String s4 = session.getProperty("mail." + name2 + ".fetchsize");
            if (s4 != null) {
    ...
    /*  JADX ERROR: IndexOutOfBoundsException in pass: RegionMakerVisitor
        ...
        */
    protected synchronized boolean protocolConnect(java.lang.String r18, int r19, java.lang.String r20, java.lang.String r21) throws javax.mail.MessagingException {
        /*
            r17 = this;
            monitor-enter(r17)
            r16 = 0
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:52:?, code lost:
        com.sun.mail.imap.IMAPStore.ConnectionPool.access$18(r10.pool, (com.sun.mail.imap.protocol.IMAPProtocol) null);
     */
