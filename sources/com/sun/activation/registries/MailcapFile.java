...
public class MailcapFile {
    ...
    public Map getMailcapList(String mime_type) {
        ...
        if (mime_type.substring(separator + 1).equals(Marker.ANY_MARKER)) {
            return search_result;
        }
        Map wildcard_result = (Map) this.type_hash.get(String.valueOf(mime_type.substring(0, separator + 1)) + Marker.ANY_MARKER);
    ...
    public Map getMailcapFallbackList(String mime_type) {
        ...
        Map wildcard_result = (Map) this.fallback_hash.get(String.valueOf(mime_type.substring(0, separator + 1)) + Marker.ANY_MARKER);
        if (wildcard_result == null) {
            return search_result;
        }
        if (search_result != null) {
    ...
    public void parseLine(String mailcapEntry) throws MailcapParseException, IOException {
        ...
        String subType = Marker.ANY_MARKER;
